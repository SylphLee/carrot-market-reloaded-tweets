...
import { createComment } from "@/app/tweets/[id]/actions";
...
const TweetCommentList = ({ commentsData, tweetId, user }: ICommentListProps) => {
  ...
  const handleSubmit = async (payload: string) => {
    ...
    await createComment(tweetId, payload, user.id);
  };
  return (
    <>
